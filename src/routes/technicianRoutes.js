...
router.get('/:technicianId/schedules', technicianController.getSchedulesOfTechnician);
...
router.post('/complete-profile', authenticateToken, handleMulter.fields([{ name: 'frontIdImage', maxCount: 1 }, { name: 'backIdImage', maxCount: 1 }, { name: 'businessLicenseImage', maxCount: 1 }, { name: 'certificates', maxCount: 10 }]), technicianController.completeTechnicianProfile);
